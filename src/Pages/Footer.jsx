  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.instagram.com/_baxriddinovv_a/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">© 2024 Abubakr's Portfolio. All rights reserved. Prepared by Abubakr.
</p>
        <div className="footer--social--icon">
          <ul>
            <li>
